...
// ---------------------------------------------------------------------------
// Program.cs
// <TODO: // Using the same word list given in the Spelling Bee assignment, building a frequency table with occurrence of all the letters.
...
namespace Training {
   ...
   internal class Program {
      #region Methods ---------------------------------------------
      /// <summary>This method displays the first 7 letters to be used as the seed for the Spelling Bee program in descending order</summary>
      /// <param name="args">arguments</param>

      private static void Main (string[] args) {
         string[] wordList = File.ReadAllLines (@"C:\etc\words.txt");
         Dictionary<char, int> result = new ();
         foreach (var word in wordList) foreach (char ch in word) result[ch] = result.TryGetValue (ch, out int value) ? ++value : 1;
